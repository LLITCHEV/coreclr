...
public:
    ...
    ReturnRegisterTypes(emitAttr firstRegType)
    {
    ...
    ReturnRegisterTypes(const ReturnRegisterTypes& callReturnRegisterTypes) = default;

#if FEATURE_MULTIREG_RET
    ReturnRegisterTypes(emitAttr firstRegType, emitAttr secondRegType)
    {
        firstRegisterType = firstRegType;
