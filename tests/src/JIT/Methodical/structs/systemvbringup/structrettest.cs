...
namespace structinreg
{
    ...
    class Program0
    {
        ...
        [MethodImplAttribute(MethodImplOptions.NoInlining)]
        Test34 test6(Test35 t5)
        {
            int fRes = t5.foo1.iFoo + t5.foo1.iFoo;
            Console.WriteLine("From Test6 members: {0} {1}", t5.foo1.iFoo, t5.foo1.iFoo);
        ...
        public static int Main1()
        {
            ...
            Console.WriteLine("test6 Result: {0}", t6es.foo1.iFoo + t6.foo2.iFoo);
            if ((t6es.foo1.iFoo + t6.foo2.iFoo) != 57) {
